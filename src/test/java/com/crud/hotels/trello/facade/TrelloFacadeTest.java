package com.crud.hotels.trello.facade;

import com.crud.hotels.trello.validator.TrelloValidator;
...
class TrelloFacadeTest {
    ...
    public void shouldCreateTrelloCardDto() {
        ...
        assertEquals("card", createdTrelloCardDto1.getName());
        assertEquals("uri.com", createdTrelloCardDto1.getShortUrl());
