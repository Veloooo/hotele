package com.crud.hotels.trello.client;

import com.crud.hotels.trello.config.TrelloConfig;
...
public class TrelloClientTest {
    ...
    void shouldReturnEmptyList() throws URISyntaxException {
        ...
        // When
        List<TrelloBoardDto> fetchedTrelloBoards = trelloClient.getTrelloBoardsNull();
        // Then
